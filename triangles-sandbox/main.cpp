...
#				endif
		...
		switch( testId )
		{
			...
			case 4: {
				draw_triangle_solid(surface, { 0.f, 0.f }, { 50.f, 0.f }, { 0.f, 60.f }, { 255, 255, 255 });
			} break;
			case 5: {
			...
			case 6: {
				draw_triangle_solid(surface,
					{ 150.f, 150.f }, { 100.f, 100.f }, { 200.f, 100.f },
					{ 255, 255, 255 }
				);
			...
			case 7: {
				draw_triangle_interp(surface, 
					{ fbwidth + 10.f, fbheight / 2.f }, { fbwidth + 100.f, fbheight / 3.f }, { fbwidth + 100.f, fbheight / 4.f },
